...
/*
 * Props to Rafal Tomal, Nick Croft, Nathan Rice, Ron Rennick, Josh Byers
 * and Brian Gardner for collaboratively writing this plugin.
 */

 /*
  * Thanks to Tyler Smith for creating the awesome jquery FlexSlider plugin -
...
add_action( 'after_setup_theme', 'genesis_responsive_slider_init', 15 );
/**
 * Loads required files and adds image via Genesis Init Hook
 */
function genesis_responsive_slider_init() {
	...
	add_action( 'widgets_init', 'genesis_responsive_slider_register' );
...
function genesis_responsive_slider_sanitization() {
	genesis_add_option_filter( 'one_zero', GENESIS_RESPONSIVE_SLIDER_SETTINGS_FIELD, array(
		'slideshow_arrows',
	...
	genesis_add_option_filter( 'no_html', GENESIS_RESPONSIVE_SLIDER_SETTINGS_FIELD, array(
		'post_type',
		'posts_term',
		'exclude_terms',
		'include_exclude',
 ...
 */
function genesis_responsive_slider_register() {
...
class Genesis_Responsive_Slider_Widget extends WP_Widget {
	 ...
	 * Display widget.
	 *
	 * @param  array  $args     Slider args.
	 * @param  object $instance Slider instance.
	 * @return void
	 */
	...
	<div id="genesis-responsive-slider">
		<div class="flexslider">
			...
			while ( $slider_posts->have_posts() ) :
				...
				<?php if ( 1 == $show_excerpt || 1 == $show_title ) : ?>
...
<?php
	...
	function form( $instance ) {
		...
		/* Translators: Slider options instructions. */
